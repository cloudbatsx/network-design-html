...
//
//   tools/rack-faces/rack-faces.svg          the sprite, for use outside this project
//   tools/rack-faces/rack-face-map.json      semantic keys -> symbol ids
//   tools/rack-faces/rack-face-preview.html    the review page
//   starters/                          the inlined copy each document carries
//
// The drawing itself lives in tools/rack-faces/rack-face-core.js. Edit that, then run:
//
...
const faceDir = path.join(root, "tools", "rack-faces");
...
<code>tools/rack-faces/rack-face-core.js</code>. The top drawing is the artwork at its native 19-inch
...
fs.writeFileSync(path.join(faceDir, "rack-face-preview.html"), preview);
